...
class E_Bitmap : public EScript::ReferenceObject<Util::Reference<Util::Bitmap> > {
	...
	public:
		...
		//! (factory) may return nullptr
		static E_Bitmap * create(Util::Bitmap * bitmap)		{	return bitmap==nullptr?nullptr:new E_Bitmap(bitmap);}

		E_Bitmap(Util::Bitmap * bitmap);
		virtual ~E_Bitmap();
...
ES_CONV_OBJ_TO_EOBJ(Util::Bitmap*, 						E_Util::E_Bitmap,					new E_Util::E_Bitmap(obj))
